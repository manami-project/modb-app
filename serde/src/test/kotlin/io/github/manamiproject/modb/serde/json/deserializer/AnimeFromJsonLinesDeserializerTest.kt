...
internal class AnimeFromJsonLinesDeserializerTest {
    ...
    inner class DeserializeTests {
        ...
        fun `throws exception if the stream is closed`() {
            // given
            val deserializer = AnimeFromJsonLinesDeserializer()
    ...
    inner class CompanionObjectTests {
        ...
        fun `instance property always returns same instance`() {
            // given
            val previous = AnimeFromJsonLinesDeserializer.instance

            // when
            val result = AnimeFromJsonLinesDeserializer.instance

            // then
            assertThat(result).isExactlyInstanceOf(AnimeFromJsonLinesDeserializer::class.java)
