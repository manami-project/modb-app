    ...
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                ...
                description.set("This lib contains downloader and converter for downloading raw data from notify.moe and convert it to an anime object.")
