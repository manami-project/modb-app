...
internal class ProducerAdapterTest {
    ...
    inner class FromJsonTests {
        ...
        fun `correctly deserialize non-null value`() {
            ...
            // when
            val result = adapter.fromJson("\"nippon television network\"")

            // then
            assertThat(result).isEqualTo("nippon television network")
        }
    ...
    inner class ToJsonTests {
        ...
        fun `correctly serialize non-null value`() {
            // given
            val adapter = ProducerAdapter()
            val obj = "nippon television network"
