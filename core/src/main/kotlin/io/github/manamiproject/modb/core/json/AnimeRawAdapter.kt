...
internal class AnimeRawAdapter: JsonAdapter<AnimeRaw>() {
    ...
    override fun fromJson(reader: JsonReader): AnimeRaw {
        ...
        when {
            ...
            //FIXME: activate after migrating DCS files: !studiosDeserialized -> throw IllegalStateException("Property 'studios' is either missing or null.")
            //FIXME: activate after migrating DCS files: !producersDeserialized -> throw IllegalStateException("Property 'producers' is either missing or null.")
