...
public data class AnimeRaw(
     ...
     * + Scores from all meta data providers are collect. However, only one instance of a score per meta data provider is kept. Latest score added wins.
     * @since 1.0.0
    ...
    override fun toString(): String {
        return """
            Anime(
              ...
              thumbnail = $thumbnail
              duration = $duration
              scores = ${scores.sortedBy { it.hostname }}
