        ...
        inner class DataSetFilestests {
            ...
            fun `throws exception if json minified file has differing number of entries`() {
                tempDirectory {
                    ...
                    // then
                    assertThat(result).hasMessage("Number of dataset files differ: [jsonMinified=1, jsonMinifiedZst=2, datasetJsonLines=2, datasetJsonLinesZst=2]")
                }
            }
            ...
            fun `throws exception if minified zst file has differing number of entries`() {
                tempDirectory {
                    ...
                    // then
                    assertThat(result).hasMessage("Number of dataset files differ: [jsonMinified=2, jsonMinifiedZst=1, datasetJsonLines=2, datasetJsonLinesZst=2]")
                }
            }
            ...
            fun `throws exception if json lines file has differing number of entries`() {
                tempDirectory {
                    ...
                    // then
                    assertThat(result).hasMessage("Number of dataset files differ: [jsonMinified=2, jsonMinifiedZst=2, datasetJsonLines=1, datasetJsonLinesZst=2]")
                }
            }
            ...
            fun `throws exception if json lines zst file has differing number of entries`() {
                tempDirectory {
                    ...
                    // then
                    assertThat(result).hasMessage("Number of dataset files differ: [jsonMinified=2, jsonMinifiedZst=2, datasetJsonLines=2, datasetJsonLinesZst=1]")
                }
            }
        ...
        inner class DeadEntriesFilesTests {
            ...
            fun `throws exception if json minified file has differing number of entries`() {
                tempDirectory {
                    ...
                    // then
                    assertThat(result).hasMessage("Number of dead entries files differ for [other-example.me]: [jsonMinified=1, JsonMinifiedZst=2]")
                }
            }
            ...
            fun `throws exception if minified json zst file has differing number of entries`() {
                tempDirectory {
                    ...
                    // then
                    assertThat(result).hasMessage("Number of dead entries files differ for [example.org]: [jsonMinified=1, JsonMinifiedZst=2]")
                }
            }
