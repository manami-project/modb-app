 ...
 *
 * ℹ️ This implementation is currently not in use.
 * It is kept as an alternative / backup implementation. See [NotifyDatasetDownloadCrawler] instead.
 * @since 1.0.0
 ...
 * @see NotifyDatasetDownloadCrawler
 */
class NotifyCrawler(
